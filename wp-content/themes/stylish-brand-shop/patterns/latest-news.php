<?php
 /**
  * Title: Latest News
  * Slug: stylish-brand-shop/latest-news
  * Categories: stylish-brand-shop
  */
?>

<!-- wp:group {"tagName":"main","style":{"spacing":{"padding":{"top":"40px","right":"40px","bottom":"40px","left":"40px"},"blockGap":"0px"}},"layout":{"inherit":true,"type":"constrained","contentSize":"100%"}} -->
<main class="wp-block-group" style="padding-top:40px;padding-right:40px;padding-bottom:40px;padding-left:40px"><!-- wp:group {"tagName":"main","style":{"spacing":{"padding":{"top":"40px","right":"40px","bottom":"40px","left":"40px"},"blockGap":"0px"}},"layout":{"inherit":true,"type":"constrained","contentSize":"90%"}} -->
...
<div class="wp-block-group"><!-- wp:group {"className":" wow bounceInDown","style":{"spacing":{"blockGap":"10px"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group wow bounceInDown"><!-- wp:group {"layout":{"wideSize":"34px"}} -->
...
<p class="has-text-align-left has-primary-color has-text-color has-medium-font-size" style="letter-spacing:1px"><?php esc_html_e('From Our Blog','stylish-brand-shop'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:heading {"textAlign":"left","className":" wow bounceInDown","style":{"typography":{"lineHeight":"1.3"}},"fontSize":"slider-title"} -->
<h2 class="wp-block-heading has-text-align-left wow bounceInDown has-slider-title-font-size" style="line-height:1.3"><?php esc_html_e('Recent News','stylish-brand-shop'); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:buttons {"className":" wow bounceInDown","style":{"spacing":{"blockGap":"10px","margin":{"top":"20px","bottom":"20px"}}},"layout":{"type":"flex","justifyContent":"left"}} -->
<div class="wp-block-buttons wow bounceInDown" style="margin-top:20px;margin-bottom:20px"><!-- wp:button {"textColor":"foreground","className":"is-style-fill","style":{"spacing":{"padding":{"right":"35px","left":"35px"}},"border":{"radius":"5px"},"elements":{"link":{"color":{"text":"var:preset|color|foreground"}}}}} -->
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link has-foreground-color has-text-color has-link-color wp-element-button" href="#" style="border-radius:5px;padding-right:35px;padding-left:35px"><?php esc_html_e('Explore More','stylish-brand-shop'); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"className":"has-shadow-dark  wow bounceInDown","style":{"spacing":{"padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}},"layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group has-shadow-dark wow bounceInDown" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><!-- wp:post-featured-image {"isLink":true,"align":"wide","className":"no-padding"} /-->
